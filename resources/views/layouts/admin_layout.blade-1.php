    ...
    <div class="container-fluid p-0 m-0">
        <div class="row p-0 m-0">
            ...
            <div class="row justify-content-end p-0 mx-0" style="margin-top:35px">
                <div class="dashboard-left-side fixed-top p-0 mx-0" style="margin-top:35px !important">
                    <div class="pt-5">
                        <ul class="m-0 p-0 unstyled-list" id="main-menu">
							<li class="position-relative menu">
								<a href="{{route('admin.add-category')}}" class="text-white nav-item show_page" id="add_category">
									Add Category
								</a>
							</li>
							{{-- <li class="position-relative menu">
								<a href="{{route('admin.add-category')}}" class="text-white nav-item show_page" id="subcategory">
									Add Subecategory
								</a>
							</li> --}}
							<li class="position-relative menu">
								<a href="{{route('admin.add-brand')}}" class="text-white nav-item show_page" id="addbrand">
									Add Brand
								</a>
							</li>
							<li id="add-product">
                                <a href="{{route('admin.add-product')}}" class="text-white nav-item add-record" id="product">Add Product</a>
                            </li>
							<li class="position-relative menu ">
                                <span class='text-white nav-item cursor-pointer'>Posts</span>
								<ul class="unstyled-list d-none p-0 top-0 position-absolute bg-dark submenu setting-menu">
									<li id="create"><a href="{{route('admin.single/post')}}" class="text-white nav-item show_page" id="single-post">Post</a></li>
									<li><a href="{{route('admin.post/all')}}" class="text-white nav-item">All Posts</a></li>
								</ul>
                            </li>
							<li class="position-relative menu">
                                {{-- <a class='text-white nav-item'>Pages</a> --}}
                            ...
                            <li class="position-relative menu ">
                                {{-- <a class="text-white nav-item">Settings</a> --}}
