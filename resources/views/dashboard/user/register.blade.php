    ...
    <div class="container-fluid p-0 m-0">
        <div style="height: 100vh" class="bg-light d-flex">
            <div class="col-3 m-auto px-4 pb-4 pt-2 rounded loginForm">
                <h2 class="text-center text-white text-uppercase fs-4">User</h2>
                <form class="m-auto" action="{{route('user.create')}}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="name" class="form-label text-white">Name</label>
                        <input type="name" class="form-control shadow-none border-1" id="name" name="name"
